...
def open_out_file():
    ...
    f.write('<style>td { text-align: right }.center { text-align: center; } body {font-family: Arial, sans-serif;background-image: url(hotel2.jpg)}table, th, td {border: 1.5px solid black;border-collapse: collapse;}</style>\n')
    f.write('</head><body style="font-family: Arial, sans-serif;">\n')
    f.write('<table border="2" style="color: #ffffff; background-color:#006d00; margin: auto; width: 50%;">\n')
